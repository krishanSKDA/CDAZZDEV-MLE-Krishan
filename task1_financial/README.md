...
- `src/llm_reasoning.py` - Task 1B: headline sentiment + Buy/Hold/Sell signal reasoning via Groq
...
2. Add your free Groq API key (console.groq.com) as a Colab secret named `GROQ_API_KEY`.
