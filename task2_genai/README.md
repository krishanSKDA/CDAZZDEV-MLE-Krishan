...
- `src/dataset_generation.py` - Task 2A: teacher-model (Groq Llama-3-70B) data generation, diversity report, JSONL chat-format split
...
2. Add Colab secrets: `GROQ_API_KEY` (required), `HF_TOKEN` (optional, to push
...
- **Teacher != student**: teacher is Groq's hosted Llama-3-70B; student is a
